! function (a) {
	...
	e.DEFAULTS = {
		...
		var b = this;
		this.$btnToolbar = a('<div class="btn-toolbar"/>'), this.$dropdownGroup = a('<div class="btn-group dropdown-btn-group pull-right" />'), this.$dropdownBtn = a('<button class="btn btn-default dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-check-square-o"></i> Display <span class="caret"></span></button>'), this.$dropdownContainer = a('<ul class="dropdown-menu dd-high"/>'), this.options.addFocusBtn && (this.$focusGroup = a('<div class="btn-group focus-btn-group" />'), this.$focusBtn = a('<button class="btn btn-default">Focus</button>'), this.options.focusBtnIcon && this.$focusBtn.prepend('<span class="' + this.options.focusBtnIcon + '"></span> '), this.$focusGroup.append(this.$focusBtn), this.$btnToolbar.append(this.$focusGroup), this.$focusBtn.click(function () {
		...
		this.$displayAllBtn && this.$displayAllBtn.toggleClass("btn-dafault", b), this.$table.toggleClass("display-all", b), this.$tableClone && this.$tableClone.toggleClass("display-all", b), c && a(window).trigger(this.displayAllTrigger)
		...
		b.$hdrCells.each(function (c) {
			...
			if (e || (e = b.idPrefix + c, d.prop("id", e)), "" === f && (f = d.attr("data-col-name")), d.is("[data-priority]")) {
				var g = a('<li class="checkbox-row"><div class="form-check"><input type="checkbox" name="toggle-' + e + '" id="toggle-' + e + '" value="' + e + '" /><span class="label-text"><label for="toggle-' + e + '">' + f + "</label></span></div> </li>"),
					h = g.find("input");
